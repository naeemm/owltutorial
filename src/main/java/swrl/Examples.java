...
public class Examples {
    ...
    private static final String PIZZA_IRI = "pizza.owl";
	...
	public static void main (String[] args) {
		...
		//		System.out.println("========================  shouldAddClassAssertion()  =======================");
		//		ex.shouldAddClassAssertion();
			
		//		System.out.println("========================  shouldAddAxiom()  ==========================");
		//	  	ex.shouldAddAxiom();		  	

		//	  	System.out.println("========================  shouldAddClassAssertion() ======================");
		//	  	ex.shouldAddClassAssertion();
			  	
		//	  	System.out.println("========================  shouldAccessEntities  ======================");
		//	  	ex.shouldAccessEntities();
			  	
		//	  	System.out.println("======================== shouldAddAxiom()   ======================");
		//	  	ex.shouldAddAxiom();
			  	
		//	  	System.out.println("======================== shouldAddObjectPropertyAssertions   ======================");
		//	  	ex.shouldAddObjectPropertyAssertions();
			  	
		//	  	System.out.println("========================  shouldBuildDataRanges()  ======================");
		//	  	ex.shouldBuildDataRanges();
			  	
		//	  	System.out.println("========================  shouldCreateAndReadAnnotations()  ======================");
		//	  	ex.shouldCreateAndReadAnnotations();
			  	
		//	  	System.out.println("========================  shouldCreateAndSaveOntology()  ======================");
		//	  	ex.shouldCreateAndSaveOntology();
			  	
		 // 	System.out.println("========================  shouldCreatePropertyAssertions()  ======================");
		 // 	ex.shouldCreatePropertyAssertions();
			  	
		//	 	System.out.println("========================  shouldCreateOntology()  ======================");
		//	  	ex.shouldCreateOntology();
			  	
			  	System.out.println("======================== shouldCreateAndSaveOntology()  ======================");
			  	ex.shouldCreateAndSaveOntology();
			
			//	System.out.println("========================  shouldCreateInferredAxioms()  ======================");
			// 	ex.shouldCreateInferredAxioms();
			  	
			// 	System.out.println("======================== shouldCreatePropertyAssertions()   ======================");		  	
			// 	ex.shouldCreatePropertyAssertions();
			  	
			// 	System.out.println("======================== shouldCreateRestrictions()   ======================");
			// 	ex.shouldCreateRestrictions();
			 	
		//	 	System.out.println("======================== shouldAddClassAssertion()   ======================");
		//	 	ex.shouldAddClassAssertion();
			 	
//			 	ex.System.out.println("======================== shouldAddAxiom()   ======================");
//			 	shouldDeleteIndividuals();
			 	
//			 	System.out.println("======================== shouldExtractModules()  ======================");
//			 	ex.shouldExtractModules();
			 	
//			 	System.out.println("======================== shouldInstantiateLiterals()  ======================");
		//	 	ex.shouldInstantiateLiterals();
			 	
//			 	System.out.println("======================== shouldLoad()  ======================");
		//	 	ex.shouldLoad();
			 	
		//	 	System.out.println("======================== shouldLoadAndSave()  ======================");
		//		ex.shouldLoadAndSave(); 
				
		//		System.out.println("======================== shouldLookAtRestrictions()  ======================");
	//			ex.shouldLookAtRestrictions();
				
	//		 	System.out.println("======================== shouldMergeOntologies()  ======================");
	//		 	ex.shouldMergeOntologies();
			 	
	//		 	System.out.println("========================  shouldQueryWithReasoner() ======================");
	//		 	ex.shouldQueryWithReasoner();
			 	
	//		 	System.out.println("======================== shouldSaveOntologies()  ======================");
	//		 	ex.shouldSaveOntologies();
			 	
	//			System.out.println("======================== shouldUseDataranges() ======================");
	//			ex.shouldUseDataranges();
				
				//   System.out.println("===========    Problematic ======================");
				//   ex.shouldUseIRIMappers();
				//   ex.shouldUseReasoner();
				
//				System.out.println("========================    ======================");
//				ex.shouldWalkOntology();
    ...
    public void shouldLoad() throws OWLOntologyCreationException {
        ...
        IRI iri = IRI.create("pizza.owl");
        OWLOntology pizzaOntology = manager
                .loadOntologyFromOntologyDocument(new File(PIZZA_IRI));
    ...
    public void shouldSaveOntologies() throws OWLOntologyStorageException,
        ...
        // document IRI
   //     IRI documentIRI = IRI.create("pizza.owl");
        OWLOntology pizzaOntology = manager.loadOntologyFromOntologyDocument(new File(PIZZA_IRI));
        System.out.println("Loaded ontology: " + pizzaOntology);
    ...
    public void shouldCreateAndSaveOntology()
        ...
        IRI documentIRI = IRI.create("file:/home/mnaeem/workspace/owltutorial/SWRLTest.2.owl");
        // Set up a mapping, which maps the ontology to the document IRI
        SimpleIRIMapper mapper = new SimpleIRIMapper(ontologyIRI, documentIRI);
        manager.addIRIMapper(mapper);
        // Now create the ontology - we use the ontology IRI (not the physical
 ...
 = dataFactory
    ...
    public void shouldDeleteIndividuals() throws OWLOntologyCreationException {
        ...
        OWLOntologyManager man = OWLManager.createOWLOntologyManager();
        OWLOntology ont = man.loadOntologyFromOntologyDocument(new File (PIZZA_IRI));
    ...
    public void shouldUseReasoner() throws OWLOntologyCreationException {
        String DOCUMENT_IRI = "http://owl.cs.manchester.ac.uk/repository/download?ontology=file:people.owl&format=RDF/XML";
    ...
    public void shouldCreateAndReadAnnotations()
        ...
        File fl = new File(PIZZA_IRI);
        OWLOntology ont = man.loadOntologyFromOntologyDocument(fl);
        System.out.println("Loaded: " + ont.getOntologyID());
    ...
    public void shouldMergeOntologies() throws OWLOntologyCreationException,
        ...
        OWLOntologyManager man = OWLManager.createOWLOntologyManager();
        man.loadOntologyFromOntologyDocument(new File (PIZZA_IRI));
        man.loadOntologyFromOntologyDocument(new File ("amino-acid.owl"));
    ...
    public void shouldExtractModules() throws OWLOntologyCreationException,
            OWLOntologyStorageException {
        String DOCUMENT_IRI = "pizza.owl";
        // Create our manager
        OWLOntologyManager man = OWLManager.createOWLOntologyManager();
        // Load the pizza ontology
        OWLOntology ont = man.loadOntologyFromOntologyDocument(new File (DOCUMENT_IRI));
        System.out.println("Loaded: " + ont.getOntologyID());
